...
class AuthManager {
    ...
    async checkAuth() {
        ...
        try {
            const response = await fetch(`${CONFIG.API_BASE_URL}/admin/api/auth/verify`, {
                method: 'GET',
    ...
    async login(email, password, rememberMe = false) {
        try {
            ...
            const response = await fetch(`${CONFIG.API_BASE_URL}/admin/api/auth/login`, {
                method: 'POST',
                headers: {
    ...
    async changePassword(currentPassword, newPassword) {
        try {
            const response = await fetch(`${CONFIG.API_BASE_URL}/admin/api/auth/change-password`, {
                method: 'POST',
    ...
    async updateProfile(profileData) {
        try {
            const response = await fetch(`${CONFIG.API_BASE_URL}/admin/api/auth/profile`, {
                method: 'PUT',
                headers: this.getAuthHeaders(),
